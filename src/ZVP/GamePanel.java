...
public class GamePanel extends JLayeredPane implements MouseMotionListener {
    ...
    //label to show sun score
    private JLabel sun;

    //random to make random
    ...
    /**
     * image maker to set images
     * and plant card to set cards
     */
    ImageMaker im;
    ...
    public GamePanel(boolean isNormal){
        ...
        //set mowers  and sun label to show sun score
        setMowers();
        setSunLabel();
        ...
        gameParts = new Timer ((6000) , (ActionEvent e) -> {
            counter++;
            if (counter < 5){
                addRandomZombie();
                Timer makeZombie1 = new Timer((6000), (ActionEvent e2) -> {
                    addRandomZombie();
                });
                makeZombie1.start();
                ...
                addRandomZombie();
                addRandomZombie();
                Timer makeZombie2 = new Timer((30000), (ActionEvent e2) -> {
                    addRandomZombie();
                    addRandomZombie();
                });
                makeZombie2.start();
                if (System.currentTimeMillis() >= startTime + 330000)
                    makeZombie2.stop();
            } else if (counter < 16){
                addRandomZombie();
                addRandomZombie();
                Timer makeZombie3 = new Timer((25000), (ActionEvent e2) -> {
                    addRandomZombie();
                    addRandomZombie();
                });
                makeZombie3.start();
